...
- **Composed-by (forward-stated):** the future system-scope `pmo-architect` Specialist (invokes this skill for within-component design depth, then adds the cross-component synthesis). Not built in this release.
