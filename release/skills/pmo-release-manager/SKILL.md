...
**Composition:** composes [`release-executor`](../release-executor/SKILL.md) **Mode A (Execute Release, `SKILL.md:154`)** for the apply, chained with **Mode F (Publish Release, `SKILL.md:379`)** for the Surface-1 emit. Re-implements neither the execute sequence nor the publish state-machine.
...
**Composition:** composes [`release-executor`](../release-executor/SKILL.md) **Mode D (Close Release, `SKILL.md:264`)** — which wraps `automated-closeout.sh` and surfaces the issue-closure audit at Step 2.5 (`SKILL.md:290`) — and optionally **Mode E (Author Release Note, `SKILL.md:316`)** on the prose-fill branch. Re-implements neither the close-out script nor the note-authoring branch.
