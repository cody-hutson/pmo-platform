...
- **ADR-114** (the ADR section set and the durability-hygiene carve-out, same release) — the **companion, not the parent**. ADR-114 governs what an ADR must contain and who may edit it; this record governs how the corpus is indexed and how far a conformance claim over it may reach. Decision (6) here amends nothing in ADR-114; the delta-scoped structural rule and its rejected scopings are ADR-114's own, recorded there.
