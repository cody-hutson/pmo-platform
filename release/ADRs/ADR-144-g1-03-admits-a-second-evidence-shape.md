...
**One normative statement survives.** The admissible set and the co-presence rule are stated **once**, in the G1-03 criterion row. The self-repair row, the check's header comment, the check's FAIL message, the authoring guide's new evidence section, both intake templates, and the triage stage spec all **cite or point**; zero restatements survive. A future change to the vocabulary has exactly one edit site.
