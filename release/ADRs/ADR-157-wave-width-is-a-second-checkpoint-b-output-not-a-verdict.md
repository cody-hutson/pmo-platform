...
---
title: "ADR-157 — Wave width is a second Checkpoint B output, not a verdict"
status: Accepted
date: 2026-08-27
...
# ADR-157 — Wave width is a second Checkpoint B output, not a verdict
...
**Numbering provenance — `151 → 157`.** Held **ADR-151** branch-local; renumbered to **ADR-157** at merge time by `release/tools/renumber-adr.py`, because the mainline already claimed 151. In-release citations that read "ADR-151" denote this record.
