...
---
title: "ADR-158 — Dry-run predicts, apply asserts: mode-branch placement in phased close-out tooling"
status: Accepted
date: 2026-08-27
...
# ADR-158 — Dry-run predicts, apply asserts: mode-branch placement in phased close-out tooling
...
**Numbering provenance — `152 → 158`.** Held **ADR-152** branch-local; renumbered to **ADR-158** at merge time by `release/tools/renumber-adr.py`, because the mainline already claimed 152. In-release citations that read "ADR-152" denote this record.
