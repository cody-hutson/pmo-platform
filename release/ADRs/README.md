...
| [ADR-181](ADR-181-behavioral-regression-floor-and-major-release-binding-boundary.md) | The behavioural-regression pass-rate floor and the boundary the gate binds at | Accepted | 2026-09-02 | regression-corpus-gates-releases |
<!-- ADR-INDEX:END -->
