...
| [ADR-127](ADR-127-version-tags-are-retained-not-reaped.md) | Version tags are retained, not reaped: the retention rule is homed beside the branch-deletion rule, and the recovery tool reads host policy rather than assuming it | Proposed | 2026-08-06 | hub-spoke-execution-safety |
<!-- ADR-INDEX:END -->
