...
- **ADR-126 — the sub-task status mirror is not resynced.** Same release; shares the finding that a specification without a bound writer is not an implemented behaviour.
