...
- #7665 — the review whose per-issue guard counter-design D38 took; #7834 carries the hub's correction placing that guard in #6854's slice.
- #7635 — the markdown presenter defect the `(plan)` header in Decision 10 closes.
- #6236 and #6685 — the cards whose Decision lines join this record from their own slices (D47).
