...
For full implementation detail see the [RELEASE_LOG.md entry](../logs/memory-to-corpus-codification.md) and [the release plan](../plans/memory-to-corpus-codification_RELEASE_PLAN.md).
