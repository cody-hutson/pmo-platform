...
For full implementation detail see the [RELEASE_LOG.md entry](../../RELEASE_LOG.md#deployment-log-cross-reference-integrity-ci) and [the release plan](../../plans/_unversioned/cross-reference-integrity-ci_RELEASE_PLAN.md).
