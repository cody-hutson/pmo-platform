...
core/schemas/adr-schema.md                                      # edit — #3914 § 3 gains the alternatives row + the requirement-level contract + the authority-chain table
core/standards/adr-authoring-guide.md                           # edit — #3914 § ADR template prose + template guidance comment + § Supersession carve-out H3; #3915 issue-reference H3 + reference block; #3708 stale-anchor row + exemption paragraph; #3707 operator-handle row
...
release/tools/check-adr-durability.py                           # edit — #3914 scope block + section-set citation + self-test drift case; #3708 R2-COUNT vocabulary + self-test; #3707 R3
.github/ISSUE_TEMPLATE/adr.yml                                  # edit — #3914 fifth requirement-level surface (accepted scope change SC-4)
.github/workflows/repo-integrity.yml                            # edit — #3915 reference-block pattern (accepted scope change SC-3)
core/rules/git-workflow.md                                      # edit — #3707 self-contradiction on the ADR deciders carve-out (accepted scope change SC-2)
...
core/ADRs/ADR-110-*.md                                          # new  — #3914's ADR (number derived at Commit 0 against origin/main)
core/ADRs/ADR-111-*.md                                          # new  — #3713's ADR (number sequenced after #3914's; home is that slice's determination)
...
core/ADRs/README.md                                             # edit — #1488 declare the curated-thematic-doc contract (ratified: NOT an index)
