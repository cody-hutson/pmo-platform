...
**Release total: 16 distinct source paths — 15 MODIFY, 1 NEW, 0 DELETE, 0 new executables**, plus this plan file. No card introduces a new agent-executed script, so **no script-execution allowlist companion row is owed by this release**.
