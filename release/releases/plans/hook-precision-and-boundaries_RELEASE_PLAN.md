...
**A-10 · Decision-record number re-derived at Commit 0.** The design body cited a number that concurrent merges have since taken. Next-free on the mainline is now ADR-130, measured with both probe arms. Allocate at authoring time from the mainline tree listing, never from the checker. Cosmetic / CHEAP / HIGH.
