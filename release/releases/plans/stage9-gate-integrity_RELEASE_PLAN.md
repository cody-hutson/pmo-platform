...
release/ADRs/ADR-134-a-gate-ships-armed-by-a-committed-default.md
...
| `release/ADRs/ADR-134-a-gate-ships-armed-by-a-committed-default.md` | **ADD** | the matrix-delivery gate card — AC5, the v4.03 record authored retroactively (promoted from CONDITIONAL, see **D-11**) |
| `release/ADRs/README.md` | EDIT | Stage-7 remediation — the GENERATED ADR index, regenerated so `ADR-134` has its row (see **D-19**, **D-21**) |
