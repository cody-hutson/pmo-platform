...
- Milestone: `regression-corpus-gates-releases`
- Decision records: `core/ADRs/ADR-180-output-scoring-runner-consumes-the-shipped-eval-harness-schema.md` and `release/ADRs/ADR-181-behavioral-regression-floor-and-major-release-binding-boundary.md`
