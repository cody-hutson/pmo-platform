...
| `usage` | #6180, #6893, #6848, #7531 (AC-3, co-discharged; and the EXIT CODES line for D19, landed at step 1), #6837 · #6848 also carries round 2's Site B (D50) | Stage 4; delta; #6837 R6; step 1; step 5 |
...
| the multi-command helpers (`span_invokes_tool`, `method_spans`, `comparator_phrases`, `limb_comparator`, `method_limbs`, `limbs_are_multi`, `grade_limbs`) — new at step 4, after `compare_threshold` | #6837 · #6848 (replaces `span_invokes_tool`'s body with its tool catalog, D22; D52's partial rule reads `method_spans` in `handle_deploy_check`) · #6236 (its CIAC lint calls `method_spans` and `comparator_phrases`) | step 4 |
