...
| #4761 | AC-1 | `grep -n "Proposed → Accepted" core/schemas/gate-criteria-spec.md` (single pattern — an alternation cannot survive markdown-cell pipe-escaping into the executor) | Exactly one stage named |
