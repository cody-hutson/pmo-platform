...
# v3.100 Release Plan — decision-telemetry-emission

> **Milestone:** `decision-telemetry-emission` (#295) · **Release Class:** cross-cutting · **Version:** v3.100 (slug-primary / pre-claim per ADR-092 — the concrete number binds at the Stage-12 atomic claim) · **Scope:** 6 issues (#3712, #3704, #4051, #3723, #4025, #4026) · One release branch, one PR, one merge gate.
