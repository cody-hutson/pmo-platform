...
- Release plan: this file, `release/releases/plans/ci-stable-under-transient-conditions_RELEASE_PLAN.md` — see § Deviation Log for the 34 ratified deltas between the Stage-4 plan of record and what shipped.
