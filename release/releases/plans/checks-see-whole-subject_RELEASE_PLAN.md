...
| Runtime suite | self-verification | Rows selecting on `core/deploy/**` and `.github/workflows/**`; the ratchet is the executable member and it ran green. `install-tests.yml`'s macOS jobs are CI-hosted and gate pre-merge. |
