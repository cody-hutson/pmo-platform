...
**21 declared path×card write obligations over 17 distinct paths.** `core/deploy/deploy.sh` appears once per writing card and is written by all eight; § Contention Map carries the ordering.
