...
| #6229 | AC-all | runtime | Assert the new heredoc-suppression arms are present and green: a report quoting a script invocation inside a heredoc is no longer refused; control arm asserts a genuine destructive command inside a heredoc still blocks | False positive removed; control arm observed non-zero block |
