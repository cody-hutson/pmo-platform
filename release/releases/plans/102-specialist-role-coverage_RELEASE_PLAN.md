...
| Field | Value |
|-------|-------|
| **Version** | `v4.14` — slug-only pre-claim (ADR-092); bump class `minor` |
...
| Security engineer | RUN | RUN | RUN | RUN | RUN | RUN | Net-new skill; full ladder. |
...
release/skills/pmo-security-engineer/SKILL.md
release/skills/pmo-data-engineer/SKILL.md
core/skills/registry.md
core/deploy/deploy.sh
packages/pmo-security-engineer.skill
packages/pmo-security-engineer.skill.sha256
...
| W2 | security-engineer skill body | **add** | Net-new Specialist, domain-anchored triggers. |
| W2 | data-engineer skill body | **add** | Net-new Specialist, domain-anchored triggers. |
| W3 | skill catalog | **edit** | The architect's existing row (mode cell and trigger-surface cell) plus the new-skill row. **Do not run a mechanical count sweep** — the non-role item count is invariant. |
| W3 | deploy roster array | **edit** | New skill entry. The architect is already present and owes no edit. |
| W3 | engineer packages + sidecars | **build** | Generated. |
...
| **#2094** | Build the security-engineer Specialist — engineer-role, hands-on; boundary-tested against the software engineer, the devops/SRE skill, and the extended architect's security mode. |
