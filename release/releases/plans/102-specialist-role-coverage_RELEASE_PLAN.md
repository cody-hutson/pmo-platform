...
```
core/ADRs/ADR-127-domain-is-a-parameter-of-the-architect-role.md
...
| **ADR-127** | Domain is a parameter of the architect role, exactly as altitude is — this release's own decision record, authored in-scope at W1. |
