...
release/ADRs/ADR-199-commitment-emission-forced-at-the-routing-point.md       add
...
- Architecture record: [`ADR-199`](/release/ADRs/ADR-199-commitment-emission-forced-at-the-routing-point.md) — the routing-point forcing-function decision and its rejected alternatives.
