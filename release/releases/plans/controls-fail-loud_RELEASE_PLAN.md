...
|---|---|---|---|---|
| #4318 | the gate-coverage register row for close-completeness (`core/standards/gate-efficacy-standard.md`) | pending — order 1 | — | restated in the contract commit (AC-3) |
...
|---|---|---|
| #4318 | the close-completeness probe exits 0 only on CLEAN; INCOMPLETE is advisory 2, a withheld verdict is 3, and a failed GitHub lookup is NOT-EVALUATED, never "absent" | PENDING — order 1 |
