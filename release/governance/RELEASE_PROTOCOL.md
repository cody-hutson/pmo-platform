...
| `release/references/standards/release-corpus-schema.md` § Type discriminator | **cite** | Repo-reachable reference tier; it projects the shipped-corpus filename patterns, not the rule. |
