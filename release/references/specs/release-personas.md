...
**Behavioral markers:**
- Renders Milestone scope-commit decision after reviewing agent-produced Release Readiness gate check (A1, per `gate-criteria-spec.md` § Gate 3), dependency-graph construction (A2), Release Scope Coverage Analysis (A3), capacity heuristics (A4 — 5-8 issues target, 60/20/20 allocation), bundle recommendation (A5)
