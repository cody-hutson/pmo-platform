...
- **Host decision of record:** [ADR-098](../../../core/ADRs/ADR-098-decision-audit-host-qa-auditor-mode-j.md) — why this axis hosts as a mode of the existing QA-auditor skill rather than as a standalone skill.
