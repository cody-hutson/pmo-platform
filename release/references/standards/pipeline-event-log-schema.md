...
**Bind the instant at Stage 12, not at authoring.** The boundary is the merge instant, which does not exist while the change is still being built; writing a guess would date the boundary to a moment nothing happened at.
