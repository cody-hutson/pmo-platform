...
out.append("# Edit directly or re-run setup-workspace.sh to update.")
out.append("")
out.append("[meta]")
...
out.append("pmo_platform_repo_name = \"pmo-platform\"")
out.append("")
out.append("[platform]")
out.append("work_board = \"github\"")
out.append("comms_platform = \"\"")
out.append("")
