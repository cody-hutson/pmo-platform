...
- **Waterfall / SPM** — the delivery decisions are phase-gate (milestone DoD, stage exit); the technical-risk binding is to the gate the program is approaching.
