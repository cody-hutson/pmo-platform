...
|-------------|-----------------|------------|-------------|
| **Stale RAID logs** | Items >30 days without update; no closures in 60 days; register growing but never shrinking | RAID treated as compliance artifact, not decision tool; no review cadence enforcement | Minimum weekly review; enforce closure; type-split age escalation (issues: >14d warn / >30d escalate; risks: >30d warn / >60d escalate) per the canonical [escalation-thresholds.md](../../ppm-agent/references/escalation-thresholds.md) §3; quarterly audit |
