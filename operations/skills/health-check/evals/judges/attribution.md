...
5. **Degradation cap honored** — where the only corroborating source (e.g., the Jira assignee) was unavailable, the owner finding caps at MEDIUM and routes to `## Decisions`, NOT `## Auto-Actionable` (ADR-049).
