...
> **Change-domain best-practice source.** This methodology suite (ADKAR · Kotter · Lewin · Bridges · McKinsey 7-S, above) is the registered change-domain best-practice source — self-bundled here and registered in [`framework-catalog.md`](../../../core/specs/framework-catalog.md); there is no shared `domain-best-practices/change.md` (decision recorded in [ADR-054](../../../core/ADRs/ADR-054-change-domain-best-practice-self-bundled.md)).
