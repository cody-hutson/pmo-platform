...
- The founding architecture decision for the work-item kit as a first-class,
  archetype-neutral, kind-bearing pack role — recorded as `ADR-177` in `core/ADRs/`.
