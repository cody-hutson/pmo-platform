...
CREATE TABLE files (
    ...
    folder          TEXT NOT NULL,                   -- ADR-080 union: legacy 01-governance…08-generated ∪ new 1-Governance…5-Reference + _inbox/_generated + the non-bin sentinel _project-root (ADR-137; migration window; frontmatter-schema.md § Category 6). No CHECK — folder cardinality left unconstrained at the DB layer; enum validated upstream at write.
