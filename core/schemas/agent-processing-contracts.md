...
| **Validation** | New project has PROJECT.md with frontmatter. Navigation scaffold includes at minimum: project hub page + one folder index per canonical bin (the ADR-079 closed set `1-Governance`…`5-Reference`; legacy `01-08` during the migration window). |
