...
- Action modifies governance state (`CLAUDE.md`, `OPERATIONS.md`, `RELEASE_PROTOCOL.md`, `PORTFOLIO.md`, `SESSION_STATE.md`). A skill's `SKILL.md` is deliberately NOT governance state for this indicator — see § Irreducible Human Tasks item 6a.
...
6. **Governance-file modification without approval** — CLAUDE.md, OPERATIONS.md, RELEASE_PROTOCOL.md, the `.claude/` security surface, etc. require Issue + plan + approval.
