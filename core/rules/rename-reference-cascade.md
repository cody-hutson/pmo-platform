...
| [`reference-durability-standard.md`](/core/standards/reference-durability-standard.md) | Whether a reference **should exist at all** in durable corpus. | Orthogonal. A reference can be perfectly cascaded and still be a durability violation; a durable inline summary has no reference to cascade. |
