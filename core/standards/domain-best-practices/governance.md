...
consumers: "release/references/pipeline/stage-05-solutioning.md §5.7 (domain-guide index — the design spoke consults this guide when the deliverable's domain is governance); the domain-best-practice review criterion (a Stage-5/7 reviewer checks a governance deliverable against this guide's concepts and contraindications); release/references/pipeline/stage-04-planning.md §5.7 (the domain: class field points here when domain==governance, including the pipeline-internal-exempt case); the operations/skills/pmo-technical-program-manager specialist skill (cites this guide as a design-time best-practice anchor for program tech-risk spanning the governance domain); the operations/skills/pmo-project-manager specialist skill (cites this guide as a design-time best-practice anchor for project delivery and gate governance — PMBOK · PRINCE2); the operations/skills/pmo-program-manager specialist skill (cites this guide as a design-time best-practice anchor for program-tier governance — PMBOK · PRINCE2); the operations/skills/pmo-portfolio-manager specialist skill (cites this guide as a design-time best-practice anchor for portfolio governance and value trade-offs — PMBOK · portfolio practice); the operations/skills/pmo-knowledge-manager specialist skill (cites this guide as a design-time best-practice anchor for knowledge codification — SECI · Diátaxis); the operations/skills/pmo-program-coordinator specialist skill (cites this guide as a design-time best-practice anchor for program-coordination and cadence governance — PMBOK); the release/skills/release-planner skill (cites this guide as a design-time best-practice anchor for release planning and sequencing — PMBOK · release-planning practice); and the operations/skills/pmo-product-owner specialist skill (cites this guide as a design-time best-practice anchor for value-driven prioritization and the accept/reject decision — PMBOK value-as-measure-of-success; dual-domain, also cites process.md)"
