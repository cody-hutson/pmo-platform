...
| DP-6 | Read-before-edit | Read the target artifact fully before editing it; the specifier vouches, not just the executor. | core/disciplines/build-philosophy.md:53 | option specifies an edit to an existing artifact | MODERATE | 2026-06-22 | b84ddb6 |
| DP-7 | Track-all-edits | No ungoverned changes — every change to a governed surface routes through issue → plan → PR, with the diff/history as the audit trail. | core/disciplines/build-philosophy.md:54 | option modifies a governed surface | MODERATE | 2026-06-22 | b84ddb6 |
