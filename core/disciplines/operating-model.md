...
| Quality Gate | **Gate 3 Release Readiness** — `auto` (G3-01 milestone created, G3-02 ≥1 issue, G3-04 no circular deps) + `recommend` (G3-03 dependencies satisfied, G3-05 AC measurable, G3-06 bundle rationale documented) per [`schemas/gate-criteria-spec.md` Gate 3](../schemas/gate-criteria-spec.md). Operator override with documented rationale for any gate failure. |
