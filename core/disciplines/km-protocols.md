...
|---|---|---|---|---|
| **1 Capture** | A lesson observed (retro, incident, operator correction, post-mortem) is recorded as a K5 artifact (the observation log per [`decision-discipline.md`](decision-discipline.md) § 4.1 schema, or a project lessons-learned log) | K5 | `KM-Proposed` | [`decision-discipline.md`](decision-discipline.md) § 4.1 classification threshold (all-3-hold test) |
