...
# would fork the sentinel vocabulary inside one grammar (ADR-171 D2).
NEUTRAL_SENTINEL = "*"
...
# level_role's domain is CLOSED (ADR-171 D6) — an unknown value is an ERROR,
...
# (ADR-171 D3). `role` decides whether a facet requirement applies at all; `kit_class`
...
def _validate_one_pack(rel, pack, packs_by_id, label_groups):
    ...
    if role_ok:
        ...
        # ── PACK-P07: the TWO-LEVEL kinds requiredness rule (ADR-171 D3) ─────
