...
- [ADR-164](ADR-164-system-of-record-per-mirrored-element.md) — supersedes Decision 1 in part (element-level source authority); Decisions 2-5 unaffected.
