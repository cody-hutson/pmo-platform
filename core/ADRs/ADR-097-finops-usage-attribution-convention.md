...
---
title: ADR-097 — FinOps usage attribution — session→work-item mapping convention, cross-file spoke linkage, and the unattributed bucket
status: Accepted
date: 2026-07-25
...
- ADR-096 — the sibling FinOps usage-store data-home ADR (the first of the two-ADR split for this milestone; same release branch). This ADR owns the attribution convention; ADR-096 owns the data home and schema authority.
