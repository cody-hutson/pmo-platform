...
source_observations:
  ...
  - "One of the four undelivered sections was [adapters] — which ADR-022 §1/§4 (status Accepted) names the canonical onboarding seam, and whose defaults deploy.sh Check 33 already asserted exist in the template — yet no generated config had ever contained it."
