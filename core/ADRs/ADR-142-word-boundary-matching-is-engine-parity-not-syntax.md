...
---
title: "ADR-142 — Whole-token matching under `git grep` is an engine-parity problem, not a syntax problem"
...
# ADR-142 — Whole-token matching under `git grep` is an engine-parity problem, not a syntax problem
