...
---
title: ADR-092 — FinOps usage store — operator-local data home, tracked-schema authority, git-ignore enforcement
status: Accepted
date: 2026-07-25
...
# ADR-092 — FinOps usage store: operator-local data home, tracked-schema authority, git-ignore enforcement
