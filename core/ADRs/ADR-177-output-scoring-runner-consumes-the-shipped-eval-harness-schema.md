...
---
title: "ADR-177 — The output-scoring runner consumes the shipped eval-harness schema, not a new one"
status: Accepted
date: 2026-09-02
...
# ADR-177 — The output-scoring runner consumes the shipped eval-harness schema, not a new one
