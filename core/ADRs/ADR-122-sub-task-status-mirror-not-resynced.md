...
| **ADR-120** | This release's first record, the Axis-1 work-status label surface. Its six declared rows were materialized by the emit path this record decides — the two cards meet at exactly one point, and it is that apply-set. |
